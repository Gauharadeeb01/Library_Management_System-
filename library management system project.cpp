...
public:
    ...
    void addBookToShelf(Book* book) {
        ...
        if (!alreadyExists) {
            shelf[genre].push_back(book);
        }
    }

    //Printing boos by Genre.
    ...
    void printAllBooks() {
        ...
        for (it = books.begin(); it != books.end(); it++) {
            ...
            cout << "Book Name: " << it->second->name << endl;
    ...
    //Returns book issued by user, Returns True if returned successfully and icrements book quantity
